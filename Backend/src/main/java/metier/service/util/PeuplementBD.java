...
public class PeuplementBD {
    ...
    public void peuplementEmploye(){
            ...
            Employe giselle = new Employe("Duprés","Giselle","0450692130","giselle.dupres@predictif.com",'F',true,"giselleDupres");
            serviceRecrutement.recrutement(giselle);
            Employe renaud = new Employe("Salomon","Renaud","0450695689","renaud.salomon@predictif.com",'H',false,"renaudSalomon");
            serviceRecrutement.recrutement(renaud);
            Employe gerard = new Employe("Breton","Gerard","0450698539","gereard.breton@predictif.com",'H',true,"gerardBreton");
            serviceRecrutement.recrutement(gerard);
            Employe christine = new Employe("Delafeuille","Christine","0450694123","christine.delafeuille@predictif.com",'F',true,"christineDelafeuille");
            serviceRecrutement.recrutement(christine);
            Employe francois = new Employe("Hugo","Francois","0450697469","francois.hugo@predictif.com",'H',true,"francoisHugo");
            serviceRecrutement.recrutement(francois);
            Employe romain = new Employe("Galle","Romain","0450697852","romain.galle@predictif.com",'H',true,"romainGalle");
            serviceRecrutement.recrutement(romain);
            Employe florient = new Employe("Rascoussier","Florient","0450694532","florient.rascoussier@predictif.com",'H',true,"florientRascoussier");
            serviceRecrutement.recrutement(florient);
            Employe maxence = new Employe("Drutel","Maxence","0450694741","maxence.drutel@predictif.com",'H',true,"maxenceDrutel");
            serviceRecrutement.recrutement(maxence);
            Employe marie = new Employe("Guillevic","Marie","0450698582","marie.guillevic@predictif.com",'F',true,"marieGuillevic");
            serviceRecrutement.recrutement(marie);
            Employe laura = new Employe("Kelche","Laura","0450692526","laura.kelche@predictif.com",'F',false,"lauraKelche");
